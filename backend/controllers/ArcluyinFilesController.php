...
/**
 * ArcluyinFilesController implements the CRUD actions for ArcFiles model.
 */
class ArcluyinFilesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ArcFilesSearchModel();
